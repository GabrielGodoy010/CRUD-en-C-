...
void menu(){
	system("color 33");
	system(ini);
	system("title Base de Datos");
			
cout<<"\n\n\t|------------ Base de datos Estudiante ------------|"<<endl;
cout<<"    "<<endl;	
...
void linea_carga();
 ...
 cout<<"\n\t"<<endl;};
		...
		cout<<"\n\tid"<<"|"<<"Codigo"<<"|"<<"Nombres"<<"|"<<"Apellidos"<<"|"<<"Direccion"<<"|"<<"Telefono"<<endl;
		do{
		cout<<"\n\t____________________________________________"<<endl;
		cout<<"\n\t"<<id<<"|"<<estudiante.codigo<<"|"<<estudiante.nombres<<"|"<<estudiante.apellidos<<"|"<<estudiante.direccion<<"|"<<estudiante.telefono<<endl;	
		fread(&estudiante,sizeof(Estudiante),1,archivo);
		id+=1;	
